        ...
        <div class="col-12">
            ...
            <div class="p-0 card-body table-responsive">
                ...
                <tbody>
                    ...
                    <td>{{ $course->program->name }}</td> <!-- Displaying the lecturer program name -->
                    <td>
                    ...
                    <td><a href="{{ route('course.edit', $course->id) }}" class='btn btn-primary'>Edit</a></95td>
                        <td>
                            <form action="{{ route('course.destroy', $course->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this Lecturer?');">
                                @csrf
                                @method('DELETE')
