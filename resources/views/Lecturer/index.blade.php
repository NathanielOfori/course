        ...
        <div class="col-12">
            ...
            <div class="p-0 card-body table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                    <td>{{ $lecturer->name }}</td>
                    <td>{{ $lecturer->department->name }}</td> <!-- Displaying the lecturer department name -->
                    <td>{{ $lecturer->program->name }}</td> <!-- Displaying the lecturer program name -->
                    <td>
                    ...
                    <td><a href="{{ route('lecturer.edit', $lecturer->id) }}" class='btn btn-primary'>Edit</a></95td>
                        <td>
