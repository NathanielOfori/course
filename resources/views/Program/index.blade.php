        ...
        <div class="col-12">
            ...
            <div class="p-0 card-body table-responsive">
                ...
                <tbody>
                    ...
                    <td>{{ $program->department->name }}</td> <!-- Displaying the department name -->

                    <td><a href="{{ route('department.edit', $program->id) }}" class='btn btn-primary'>Edit</a></95td>
                        <td>
                            <form action="{{ route('department.destroy', $program->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this Program?');">
                                @csrf
                                @method('DELETE')
