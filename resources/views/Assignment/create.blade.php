        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="deadline" name="deadline" class="form-control" id="deadline" placeholder="Enter deadline (dd/mm/yyyy)">
                    @error('deadline')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="grade" name="grade" class="form-control" id="grade" placeholder="Enter grade">
                </div>
                <div class="form-group">
                    <label for="score">Score</label>
                    <input type="score" name="score" class="form-control" id="score" placeholder="Enter score">
                </div>
                <div class="form-group">
